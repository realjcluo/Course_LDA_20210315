...
saveRDS(ELSA_wide, file = "ELSA_wide.RDS")
...
### Save the cleaned long dataframe
saveRDS(ELSA_long_new, file = "ELSA_long_new.RDS")
...
ELSA_wide <- readRDS(file = "ELSA_wide.RDS")


### Read in the long data if you have not run the optional code above
ELSA_long_new <- readRDS(file = "ELSA_long_new.RDS")
...
### Subset the data so that it includes individuals over the age of 50
ELSA_long_new1 <- ELSA_long_new[ELSA_long_new$indager >= 50, ]
...
## NOTE: glmer can take a long time to run
# random4 <- glmer(depressed ~ 1                                                            # outcome: depressed (0, 1)
...
### We can display this in a neater way using stargazer
stargazer(gee_3, type="text", title="Results", align=TRUE)  
...
### We can display this in a neater way using stargazer
stargazer(gee_4, type="text", title="Results", align=TRUE)  
